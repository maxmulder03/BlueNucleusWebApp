      ...
      <div className="prose prose-neutral m-4 mx-auto w-[70%] bg-[var(--primary-background)] rounded-3xl p-8">
        <Markdown
          ...
          components={{
            ...
            h2: ({ ...props }) => (
              <h3 className="md md-subheading pt-8 pb-2 font-bold text-4xl" {...props} />
            ),
            h3: ({ ...props }) => (
              <h4 className="md md-subheading pt-4 pb-2 font-semibold text-xl" {...props} />
            ),
            h4: ({ ...props }) => (
            ...
            p: ({ ...props }) => (
              <p className="md" {...props} />
            ),
            a: ({ ...props }) => (
              <a className="md" {...props} />
            ),
            ul: ({ ...props }) => (
              <ul className="md ml-8 list-disc" {...props} />
            ),
            li: ({ ...props }) => (
              <li className="md" {...props} />
            ),
            code(props) {
